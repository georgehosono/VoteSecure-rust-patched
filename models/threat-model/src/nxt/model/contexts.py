# VoteSecure Threat Model - Contexts
...
EAA = Context(
    id="EAA", name="Election Administrator Application", kind=ContextKind.SUBSYSTEM
)
EAS = Context(
    id="EAS", name="Election Administration Server", kind=ContextKind.SUBSYSTEM
)
EST = Context(
    id="EST", name="Election Administration Storage", kind=ContextKind.SUBSYSTEM
)
...
TAS = Context(
    id="TAS", name="Trustee Administration Server", kind=ContextKind.SUBSYSTEM
)
...
EAN = Context(
    id="EAN", name="Election Administration Network", kind=ContextKind.NETWORK
)
...
POPK = Context(
    id="POPK", name="Proof of Plaintext Knowledge", kind=ContextKind.PRIMITIVE
)
